...
@RestController
public class RecentlyModifiedController {
    ...
    @GetMapping("/recent")
    public ResponseEntity<String> locateRecentFiles(
        ...
        try {
            ...
            var result = new RecentlyModifiedExecutor(docsDir)
                    .getResult();
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body("Error finding last modified files");
        }
    }
