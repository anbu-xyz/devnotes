...
| `cm6-bundle` | Runs `esbuild` on `src/main/js/entry.js` → `static/generated/js/codemirror-bundle.js` |
| `vendor-bundle` | Runs `node src/main/js/build-vendor.js` → copies / bundles all other vendor assets into `static/generated/` |
...
|---|---|---|
| `htmx.org` | `1.9.12` | `static/generated/js/htmx.min.js`, `static/generated/js/htmx-json-enc.js` |
| `alpinejs` | `^3.0.0` | `static/generated/js/alpine.min.js` |
| `@fortawesome/fontawesome-free` | `5.15.3` | `static/generated/css/font-awesome.min.css`, `static/generated/webfonts/*.{eot,ttf,woff,woff2}` |
| `prismjs` | `1.25.0` | `static/generated/css/prism-tomorrow.min.css`, `static/generated/js/prism-bundle.js` |
| `mermaid` | `^11.0.0` | `static/generated/js/mermaid.min.js` |
...
5. **Prism bundle** - esbuild IIFE bundle of the Prism core plus eight language components:
   ...
   `yaml`, `mermaid` → `static/generated/js/prism-bundle.js`.
6. **Mermaid** - esbuild IIFE bundle from a tiny wrapper entry
   ...
   `globalThis.mermaid` for use in non-module `<script>` blocks → `static/generated/js/mermaid.min.js`
...
|---|---|
| Font Awesome icons | `/generated/css/font-awesome.min.css` |
| Prism syntax-highlight theme | `/generated/css/prism-tomorrow.min.css` |
| Prism syntax-highlight JS | `/generated/js/prism-bundle.js` |
| htmx | `/generated/js/htmx.min.js` |
| htmx JSON-enc extension | `/generated/js/htmx-json-enc.js` |
| Alpine.js | `/generated/js/alpine.min.js` (always loaded with `defer`) |
| Mermaid | `/generated/js/mermaid.min.js` (regular `<script>`, sets `globalThis.mermaid`) |
| CodeMirror 6 | `/generated/js/codemirror-bundle.js` (ES module) |
